<div class="right_col" role="main">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>{{ locale.posts.new_post.post_title }}</h2>
                ...
                <div class="x_content">
                    <input id="post_title" class="form-control" name="post_title" placeholder="Digite o Titulo da Postagem">
                </div>
            </div>
        </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="col-md-12 col-sm-12 col-xs-12" >
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <button class="btn btn-success form-control" onclick="postsForm.novopost()" data-toggle="tooltip" data-placement="top" title="{{ locale.posts.new_post.options.save_popup }}">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <label for="post_status">{{ locale.posts.new_post.options.status }}</label>
